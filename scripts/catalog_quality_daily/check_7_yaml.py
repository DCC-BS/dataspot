...
YAML_PROFILES = [
    ...
    ("Personendaten", "Annotation YAMLs/annotations_personendaten.yaml"),
]
...
if __name__=='__main__':
    import json
    client = BaseDataspotClient(scheme_name="Unused", scheme_name_short="NA")
    result = check_7_yaml(client)
