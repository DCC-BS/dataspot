...
kv_scheme_name = 'Kennzahlenverzeichnis'
...
assert dnk_ods_imports_collection_path, "dnk_ods_imports_collection_path must be set in config.py"
assert tdm_ods_imports_collection_name, "tdm_ods_imports_collection_name must be set in config.py"
assert tdm_ods_imports_collection_path, "tdm_ods_imports_collection_path must be set in config.py"
